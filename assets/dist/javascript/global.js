...
var classes = '';
if (platform.name){
  classes += platform.name+' ';
}
if (platform.os){
  classes += platform.os+' ';
}
if (platform.product){
  classes += platform.product+' ';
}
    ...
    $(document).ready(function () {
        $(window).load(function(){
            ...
            function hidePreloader(){
                var prealoader = $(".spinner-wrapper");
                prealoader.fadeOut(preloaderFadeOutTime);
            }
            hidePreloader();
        });
        $(".c-hamburger").on("click", function () {
            $(".c-hamburger").toggleClass("is-active");
            $(".nav-primary").slideToggle( "slow", function() {
                // Animation complete.
            });
        });
